            ...
            <nav className="main-header navbar navbar-expand navbar-primary navbar-dark">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <a href="#" onClick={(e) => navigate('/unitHead-homePage')} className="nav-link">Home</a>
                    </li>
                    {/* =============================================================== PUBLICIZE RESEARCH ================================================================================== */}
                    <li className="nav-item d-none d-sm-inline-block">
                        <a href="#" onClick={(e) => navigate('/unitHead-public-RorE')} className="nav-link">Research & Extension Programs</a>
                    </li>
                </ul>
                {/* Right navbar links */}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="card card-primary card-outline">
                            <div className="card-body box-profile">
                                ...
                                <p className="text-muted text-center">Unit Head</p>
                                <hr />
