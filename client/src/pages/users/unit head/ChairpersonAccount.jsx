    ...
    return (
                        ...
                        <div className="modal-content">
                            ...
                            <form action="../../../../res api/users account/users/unit head/chairperson/addChairperson.php" method="POST">
                                <div className="modal-body">
                                    <input type="hidden" name="added_name" defaultValue="<?php echo $fetch['fullname']; ?>" />
      ...
      ?*/}
                                    <div className="form-group">
                                        ...
                                        <input type="password" name="password" defaultValue="<?php echo $pass; ?>" className="form-control" placeholder="Password" id="pass" required />
                                        <i style={{ position: 'absolute', marginTop: '-26.5px', marginLeft: 'calc(100% - 70px)', fontSize: 20, cursor: 'pointer' }} onclick="eye()" className="fa fa-eye-slash" id="eye" />
                                    </div>
                                </div>
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button type="submit" name="addsec" className="btn btn-primary">Add</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <form action="../../../../res api/users account/users/unit head/chairperson/editChairperson.php" method="POST">
                                <div className="modal-body">
                                    <input type="hidden" id="currentEmail" name="currentEmail" defaultValue />
                                    <input type="hidden" id="update_id" name="my_id" defaultValue />
      ...
      ?*/}
                ...
                {/* List of Chairperson Account */}
                <div className="card shadow mb-4">
                    <div className="card-header py-3">
                        <h6 className="m-0 font-weight-bold text-primary"><span style={{ fontSize: 20 }}>Chairperson Accounts </span>
...
export default ChairpersonAccount
