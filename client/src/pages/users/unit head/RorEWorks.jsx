      ...
      <div className="content-wrapper">
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">Add {/*?php echo " ".$myRorE." "; ?*/}</h5>
        ...
        if ($campus == "Dapitan"){ ?*/}
                  ...
                  <div className="form-group" id="dapitan">
                    ...
                    <select className="form-control" name="college" id>
      ...
      ?*/}
        ...
        <div className="modal fade" id="yole123" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">Edit {/*?php echo " ".$myRorE." "; ?*/}</h5>
                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </button>
              </div>
              <form action="../../../../res api/users account/users/unit head/research work/editResearch.php" method="POST" encType="multipart/form-data">
                <div className="modal-body">
                  ...
                  <input type="hidden" defaultValue="<?php echo $campus; ?>" id="campusId" name="historyCampus" />
                  <input type="hidden" defaultValue="<?php echo $fetch['RorE']; ?>" id name="historyRorE" />
                  {/*?php
        if ($campus == "Dapitan"){ ?*/}
                  {/*====================== DAPITAN =======================*/}
                  <div className="form-group" id="dapitan">
      ...
      ?*/}
            ...
            <li className="nav-item dropdown no-arrow">
              ...
              <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown" style={{ marginLeft: '-300px', width: 300, textAlign: 'center' }}>
                <form action="../../../../res api/users account/users/unit head/create document/index.php" method="POST">
                  <input type="hidden" defaultValue="<?php echo $fetch['RorE']; ?>" name="RorE" />
                  <input type="hidden" defaultValue="<?php echo $fetch['campus']; ?>" name="campus" />
                  <div className="form-group" id="proposed" style={{ width: '80%', marginLeft: '10%', marginTop: 20 }}>
        ...
        <div className="card shadow mb-4" id="data1">
          <div className="card-header py-3">
            <h6 className="m-0 font-weight-bold text-primary"><span style={{ fontSize: 20 }}><span id="a1" style={{ display: 'visible', fontSize: 20 }}>{/*?php echo $myRorE." "; ?*/}Works </span><span id="a5" style={{ display: 'none' }}>Approved {/*?php echo " ".$myRorE." "; ?*/} Programs</span><span id="a2" style={{ display: 'none' }}>{/*?php echo $myRorE." "; ?*/} On-Going Papers</span><span id="a3" style={{ display: 'none' }}>{/*?php echo $myRorE." "; ?*/} Completed Papers</span><span id="a4" style={{ display: 'none' }}>Proposed {/*?php echo " ".$myRorE." "; ?*/} Papers</span></span>
