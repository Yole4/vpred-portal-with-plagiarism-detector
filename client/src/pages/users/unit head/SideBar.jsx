  ...
  return (
    <div>
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                {/* Brand Logo */}
                <a href="#" onClick={(e) => navigate('unitHead-homePage')} className="brand-link">
                ...
                <div className="sidebar">
                    ...
                    <nav className="mt-2">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            {/* =========================================================== PUBLICIZE RESEARCH ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/unitHead-public-RorE')} className="nav-link">
                                    <i className="nav-icon fas fa-copy" />
                                    <p>
                                        R & E Programs
                                    </p>
                            ...
                            {/* =========================================================== RESEARCH WORKS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/unitHead-RorE-Works')} className="nav-link">
                                    <i className="nav-icon fas fa-copy" />
                                    <p>
                            ...
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/unitHead-chairperson-account')} className="nav-link">
                            ...
                            {/* =========================================================== AUTHOR ACCOUNTS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/unitHead-author-account')} className="nav-link">
                                    <i className="nav-icon fas fa-users" />
                                    <p>
                                        Author Accounts
                                    </p>
