    ...
    return (
        <div>
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                {/* Brand Logo */}
                <a href="#" onClick={(e) => navigate('/chairperson-homePage')} className="brand-link">
                    <img src="../../CSS/img/logo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{ opacity: '.8' }} />
                    <span className="brand-text font-weight-light">Chairperson</span>
                </a>
                {/* Sidebar */}
                <div className="sidebar">
                    ...
                    <nav className="mt-2">
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            {/* =========================================================== PUBLICIZE RESEARCH ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/chairperson-public-RorE')} className="nav-link">
                                    <i className="nav-icon fas fa-copy" />
                                    <p>
                                        R & E Programs
                                    </p>
                            ...
                            {/* =========================================================== RESEARCH WORKS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/chairperson-RorE-works')} className="nav-link">
                                    <i className="nav-icon fas fa-copy" />
                                    <p>
                            ...
                            {/* =========================================================== AUTHOR ACCOUNTS ======================================================================================== */}
                            <li className="nav-item has-treeview">
                                <a href="#" onClick={(e) => navigate('/chairperson-author-account')} className="nav-link">
