            ...
            <nav className="main-header navbar navbar-expand navbar-primary navbar-dark">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <a href='#' onClick={(e) => navigate('/Home')} className="nav-link">Home</a>
                    </li>
                    {/* =============================================================== PUBLICIZE RESEARCH ================================================================================== */}
                    <li className="nav-item d-none d-sm-inline-block">
                        <a href="#" onClick={(e) => navigate('/Admin-public')} className="nav-link">Research & Extension Programs</a>
                    </li>
                </ul>
                {/* Right navbar links */}
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow">
                        <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img style={{ width: 25, height: 25 }} className="img-profile rounded-circle" src={userData && ( `${backendUrl}/uploads/${userData.image}` )} />
                        </a>
                        ...
                        <div className="card card-primary card-outline">
                            <div className="card-body box-profile">
                                <div className="text-center">
                                    <img style={{ width: 100, height: 100 }} className="profile-user-img img-fluid img-circle" src={userData && ( `${backendUrl}/uploads/${userData.image}` )} alt="User profile picture" />
                                </div>
